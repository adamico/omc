craftingTable.addShapeless("clay_ball_from_coarsed_dirt", <item:minecraft:clay_ball>, [<item:minecraft:water_bucket>.transformReplace(<item:minecraft:bucket>), <item:minecraft:coarse_dirt>]);
